prob_vm=$1
comm_benchmark="sudo /var/lib/phoronix-test-suite/installed-tests/pts/nginx-3.0.1/wrk-4.2.0/wrk -d 30s -c 200 -t 3 https://127.0.0.1:8089/test.html" 
...
comm_benchmark_1="sudo /var/lib/phoronix-test-suite/installed-tests/pts/nginx-3.0.1/wrk-4.2.0/wrk -d 30s -c 200 -t 3 https://127.0.0.1:4054/test.html" 
