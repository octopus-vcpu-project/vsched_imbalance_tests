...
sudo taskset -c 16-23 sysbench --threads=12 --report-interval=3 --time=50 cpu run >> $OUTPUT_FILE1 &
sudo taskset -c 16-23 sysbench --threads=12 --report-interval=3 --time=50 cpu run >> $OUTPUT_FILE2 
touch $OUTPUT_FILE
echo "test complete"
