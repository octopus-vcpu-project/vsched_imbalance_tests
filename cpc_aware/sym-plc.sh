...
ssh ubuntu@$compete_vm "sudo python3 /home/ubuntu/bpftrace/bcc/tools/runqlen.py -C">> "$OUTPUT_FILE" &
ssh ubuntu@$compete_vm "sudo $cpu_benchmark" &
sleep $benchmark_time
ssh ubuntu@$compete_vm "sudo kill -s SIGINT \$(pidof python)"
